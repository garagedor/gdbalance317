...
BEGIN
  ...
  IF NEW.status = 'Submitted' THEN
    ...
    -- When re-submitting a previously Returned report, clear the prior
    -- return reason and timestamp so the report appears as a fresh
    -- submission in admin queues (and doesn't carry the "Returned" banner).
