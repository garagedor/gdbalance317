...
const STEPS: Step[] = [
  {
    ...
    body: (
      <>
        <p>הרפורט השבועי נפתח <b>אוטומטית</b> בכל שבוע בשעה <b>20:00</b> לפי שעון אינדיאנה.</p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>רפורט שבועי חדש נפתח <b>אוטומטית</b> בכל שבוע בשעה <b>20:00 לפי שעון אינדיאנה</b> (America/Indiana/Indianapolis).</p>
        <p className="mt-2">השעה הזו תקפה לכל הטכנאים — ללא קשר לאזור שלך.</p>
        <p className="mt-2">השבוע: יום שני → יום ראשון.</p>
      </>
    ),
  },
  {
